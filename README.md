...
| [알고리마](#알고리마) | 유연 출근 (08:00 ~ 10:00) | X | [홈페이지](https://algorima.io/) / [채용공고](https://algorima.io/career) |
...
### 알고리마
- 편안한 근무 환경
    - 바이오리듬을 존중하는 유연한 출퇴근 시간! 8-10 AM 출근, 5-7 PM 퇴근
    - 일할 맛이 나는 쾌적한 업무 환경! 고급스러운 라운지와 푹신한 소파, 테헤란로를 바라보는 사무실 전경, 폰부스, 회의실 등 업무 및 휴식 공간 구비
    - 부장님, 과장님 없는 평균 연령 20-30대의 젊은 회사! 열일하다 지쳐 엎드려 낮잠 자도 눈치 주는 사람 없음
    - 전 임직원 호칭 통일 (ㅇㅇ님)
    - 똑똑하고 착한 사람들과의 지적인 수다! 수평적이고 자유로운 대화/토론 중시
- 아낌 없는 업무 지원
    - 업무 효율 극대화를 위한 아낌 없는 업무 장비 지원
    - 업무 관련 교육비 월 10만 원 지원
    - 업무 관련 각종 컨퍼런스, 세미나, 포럼 등 참가비 지원
    - 업무 관련 도서구입비 무제한 지원
- 먹거리 지원
    - 맛있는 간식과 커피, 그리고 콤부차 무제한 제공
    - 시리얼, 우유 무제한제공
    - 아.묻.따 저녁 제공
- 각종 휴가 및 지원 제도
    - 샌드위치데이 휴무
    - 프로젝트 마감시 전체 유급휴가
    - 3년, 5년, 7년 근속시마다 2주 리프레시 휴가
    - 각종 경조 휴가 및 경조금 지원