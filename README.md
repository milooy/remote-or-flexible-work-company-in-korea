...
- 최고 사양 개발 장비 지급
#### NHN
- 매주 수요일 원격 근무 (매회 출근/재택 선택 가능)
    - 그룹 내 법인에 따라 매주 수요일 원격 근무가 채택되지 않은 법인 존재함
- 08:00 ~ 19:00 사이 유연 출퇴근. 평균 일 근무시간 8시간은 체워야 함.
- 기본 단위 1시간, 그 이상 30분단위의 연차 사용 가능
- 본인 + 가족 + 직계 매년 건강검진 지원 (2년 단위 한번 정밀 선택 검진, 정밀검사 아닌 해는 일반 검진)
- 간편 조식, 중석식 제공 (구내식당, 무료)
- 사내 헬스장 무료 이용 가능
- 진급 시 진급 휴가비 제공 (10일치 일급 x 120%). 단 휴가 차감은 연차에서 차감되고, 휴가를 사용해야 지급 됨
- 명절 떡값 - 페이코 상품권
