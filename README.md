...
* 질병이나 업무로 인해 이미 소집예정된 훈련소 일정을 연기해야할 경우, 훈련소 입소 1주일 전 까지 훈련소 연기 서류를 병무청에 제출해야합니다.
* 질병으로 인해 훈련소를 연기할 경우, 병무용 진단서에 `훈련소 기간 동안 치료 및 요양이 필요합니다` 등의 소견문이 반드시 존재해야합니다.
