...
| [클래스팅](#클래스팅) | 완전 자율 출퇴근 / 무컨펌 무제한 휴가 | 필요 시 재택근무 가능 | [홈페이지](https://about.classting.com/) / [채용 공고](https://careers.classting.com/) |
...
> 클래스팅은 학급의 각기 다른 수준의 학생들에게 개인화된 교육을 제공할 수 없는 한 선생님의 고민에서 시작되었습니다.
> 
> 클래스팅은 수업자료를 공유하고 과제를 내고 문항을 직접 제작하거나 문제은행을 통해 문항을 조합하여 학생을 평가하고 피드백을 줄 수 있는 수업 및 학습 관리를 위한 클래스 관리 도구인 '클래스팅'과 방과후 학생들이 학교 및 클래스 친구들과 서로 경쟁하며 함께 재미있게 공부하는 소셜 게이미피케이션 러닝, '클래스팅 AI'를 통해 다년간 문제풀이 데이터를 포함하여 학습 활동에 대한 방대한 교육 데이터를 800만 이상의 회원으로부터 쌓아왔습니다. 여기에는 단순히 문제풀이 데이터 뿐 아니라 선생님이 내어준 과제나 평가에 대한 결과, 학습 참여율, 교우관계, 관심사, 어휘 등과 같은, 쌓인 다양한 정형/비정형 교육 빅데이터가 7억개 이상이 포함되어 있고, 이 독보적인 교육 빅데이터를 통해 전국 학생들의 수준을 진단하고 개개인에게 적합한 개인화된 커리큘럼을 제공하고자 노력하고 있습니다.
> 
> 고귀한 가치인 '배움'을 기술을 통해 평등하게 제공하고, 가속화하고자 하는 클래스팅의 위대한 도전에 함께 하실 동료를 찾습니다.

#### 혜택 및 복지

클래스팅은 자율/생산성/건강 측면에서 클래스터가 업무에 몰입할 수 있도록 지원합니다.

##### 1. 업무에 집중할 수 있도록 지원합니다
- 무제한 휴가
- 자율 출퇴근
- 자율 재택
- 점심, 저녁 지원
...
#### 2. 최신형 장비 지원 및 최적의 환경을 제공합니다
- 근무 영역별 공기청정기 비치
- 최신형 업무 장비 제공(최신형 노트북, 듀얼모니터 등)
- 그 외 개인별 필요장비 무제한 지원

#### 3. 조직의 성장과 개인의 성장을 지원합니다
- 각종 교육, 컨퍼런스, 도서 구입 등 지원
- 직군별 스터디 지원
- 사내추천 포상금 (추천자, 지원자 최대 각 1000만원)

#### 4. 팀워크 향상을 위해 활동 비용을 지원합니다
- 테니스, 풋살, 골프 등 동아리 활동 지원
- 팀워크 액티비티 지원

#### 5. 클래스터의 건강을 지원합니다
- 건강식 중심의 무료 스낵바 (품목 신청 가능)
- 동아리 액티비티 활동비 지원
- 건강검진 지원
- 비타민, 루테인, 유산균 등 지원

#### 6. 클래스터의 휴식을 지원합니다
- 플레이스테이션, 탁구, 안마의자 등 구비
- 각종 커피, 건강음료, 차 지원

더 궁금하신 점은 [careers@classting.com](careers@classting.com) 으로 문의해주세요~

[회사 홈페이지](https://about.classting.com/)
[채용 공고](https://careers.classting.com/)
